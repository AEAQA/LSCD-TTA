...
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))) if os.path.dirname(os.path.dirname(os.path.abspath(__file__))) not in sys.path else None
...
def get_default_parser():
    ...
    parser.add_argument('--loss-names', nargs='+', type=str, default=['em'])
